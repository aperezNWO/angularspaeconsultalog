...
export class LogInfoService {
  ...
  getLogRemoto__() {
    ...
    getLogRemoto_() {
      //
      let url='http://localhost/home/getconsultalogget?P_ID_DATA_SOURCE=1&P_ID_TIPO_LOG=1&P_ID_LOG=0&P_FECHA_INICIO=%2201-01-2001%22&P_FECHA_FIN=%2231-12-2022%22&P_ROW_NUM=-1'
      //    
      return this.http.get<LogEntry[]>(url);
    }
}
